...
<body>
    ...
    <div id="detail">
        ...
        <table class="detail_header" border=0>
            <tr>
                ...
                <td class="detail_header__letter" colspan="2"><h1> {{member?.alias}} </h1></td>
        ...
        <div class="detail_info_content_wapper">
            ...
            <div class="detail_info_content">
                ...
                <div class="detail_about">
                    <h1 class="detail_alias"> About {{member?.alias}} </h1>

                    <a v-if="member?.id == '<%=memberId%>'"
                       class="detail_about__modify">
    ...
    <script>
        window.onload = function() {
	        loadScript('/resources/js/view/detail.js');
        }
